#ifdef __APPLE__
  #define LUNIFY_LOCAL_SYMBOL(x) .private_extern x
#else
  #define LUNIFY_LOCAL_SYMBOL(x) .hidden x
#endif
...
LUNIFY_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_121666)
LUNIFY_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU0)
LUNIFY_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU1)
LUNIFY_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU2)
LUNIFY_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU3)
LUNIFY_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU4)
LUNIFY_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER0)
LUNIFY_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER1)
LUNIFY_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER2)
LUNIFY_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER3)
LUNIFY_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D0)
LUNIFY_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D1)
LUNIFY_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D2)
LUNIFY_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D3)
LUNIFY_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_38)
